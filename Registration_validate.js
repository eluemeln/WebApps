function SignUpForm(){ 
	...
	// add code here to declare variables for password and confirm password
	
    var c = document.forms.SignUp.pswd.value;

    var d = document.forms.SignUp.pswd.value;
  ...
  // initialize email_msg, uname_msg, password_msg and pswdr_msg
	...
	if (c==null ||c.length<8 ||c=="" ||pswd_v.test(c) == false){  
	    document.getElementById("pswd_msg").innerHTML="Please enter the correct format for password. (No leading or trailing spaces)";
	    result = false;
	}
	...
	if (c!= d|| d==null || d=="")
		...
		{
		document.getElementById("pswdr_msg").innerHTML="the password should be the same as the password above";
    result = false;}
